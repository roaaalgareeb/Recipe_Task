...
namespace Recipe_Task.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LoginId,Email,Password,RoleId,UserId")] Login login)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("LoginId,Email,Password,RoleId,UserId")] Login login)
        {
            if (id != login.LoginId)
            {
                return NotFound();
