...
namespace Recipe_Task.Controllers
{
    public class ContactsController : Controller
    {
        ...
        {
            var modelContext = _context.Contacts.Include(c => c.UserEmailNavigation);
        ...
        public async Task<IActionResult> Create([Bind("ContactId,Email,Message,UserEmail")] Contact contact)
        {
            ...
            ViewData["UserEmail"] = new SelectList(_context.Users, "Email", "Email", contact.UserEmail);
            return View(contact);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("ContactId,Email,Message,UserEmail")] Contact contact)
        {
