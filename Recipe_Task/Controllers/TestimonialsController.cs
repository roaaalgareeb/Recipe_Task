...
namespace Recipe_Task.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        {
            var modelContext = _context.Testimonials.Include(t => t.EmailNavigation).Include(t => t.User);
        ...
        public async Task<IActionResult> Create([Bind("TestimonialId,Email,Rating,Testi,UserId")] Testimonial testimonial)
        {
            ...
            ViewData["Email"] = new SelectList(_context.Users, "Email", "Email", testimonial.Email);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("TestimonialId,Email,Rating,Testi,UserId")] Testimonial testimonial)
        {
