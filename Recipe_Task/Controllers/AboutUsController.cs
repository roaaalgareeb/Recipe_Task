...
namespace Recipe_Task.Controllers
{
    public class AboutUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AboutusId,Imageee1,Imageee2,Description1,Titleeee1")] AboutU aboutU)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("AboutusId,Imageee1,Imageee2,Description1,Titleeee1")] AboutU aboutU)
        {
